...
LIST_TYPES: frozenset[str] = frozenset(
    {
        ...
        # file instead of raising ReplayError — _merge_audit conforms and is NOT in
        # build.READ_DIRECTLY_LEDGERS (unlike the other audit logs, which carry an
        # unregistered/absent _type and ARE excluded from the glob, wyrd-5qg7).
        "merge_audit",
