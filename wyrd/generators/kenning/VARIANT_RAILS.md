...
- Fire #27 (2026-06-23): authored 5 — sceot→`shot` (Shotley), sulh→`soul` (Soulbury), wæd→`wade` (Biggleswade), īeg→`zoy` (Chedzoy), of:bel→`beau` (Beaumont). Parked 7 (rysc, salh, salt, upp, weard, wēoh, holmr). Cumulative: 87 authored, 163 parked.
