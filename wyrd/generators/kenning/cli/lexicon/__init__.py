...
from wyrd.generators.kenning.cli.lexicon import (
    mine_duplicate_canonicals as _mine_duplicate_canonicals_module,
)
from wyrd.generators.kenning.cli.lexicon import (
...
from wyrd.generators.kenning.cli.lexicon import (
    mine_implied_reflexes as _mine_implied_reflexes_module,
)
...
_mine_duplicate_canonicals_module.add_to(lexicon)
_mine_cognate_descents_module.add_to(lexicon)
_mine_cognate_descents_llm_module.add_to(lexicon)
_mine_implied_reflexes_module.add_to(lexicon)
