...
def _curation_file_with(tmp_path: Path, rows: list[dict]) -> Path:
    """Seed a curation JSONL file with a synthetic source row + the
    given events. Mirrors what `lexicon curate-etymon` produces on
    first invocation."""
