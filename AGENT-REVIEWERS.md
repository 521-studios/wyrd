...
A reviewer pack for the wyrd Python codebase. Each section below is an independent reviewer prompt with its own scope, set of patterns to flag, and disposition.
